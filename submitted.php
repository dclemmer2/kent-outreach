<?php
//Set navbar links
$about_link = 'http://dclemmer.greenriverdev.com/305/kent-outreach/index.php#about';
$services_link = 'http://dclemmer.greenriverdev.com/305/kent-outreach/index.php#services';
$contact_link = 'http://dclemmer.greenriverdev.com/305/kent-outreach/index.php#contact';
$getInvolved_link = 'http://dclemmer.greenriverdev.com/305/kent-outreach/getInvolved.php';
$navbar_link = 'http://dclemmer.greenriverdev.com/305/kent-outreach/index.php';
...
$sql = "INSERT INTO requests VALUES(null, '$fname', '$lname', '$address1', '$address2', '$city', '$state', '$zip', '$email', '$phone', '$services', '$other', '$comments', '$timestamp', '0')";
...
<div class="container acknowledge-div pb-5" id="submitted">
